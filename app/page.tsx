        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 mt-4 text-[#25D366] text-sm font-semibold hover:text-green-400 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 mt-3 text-pink-400 text-sm font-semibold hover:text-pink-300 transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
